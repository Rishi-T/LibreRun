...
from librerun_utils import (
    ...
    LOGS_DIR, TEMP_DIR, BASE_CONFIG, SIMOUT_DIR, EXE_DIR, SIM_RUNS_DIR,
    _early_fatal,
)
...
def resolve_extension(task: str, config: dict) -> object:
    ...
    # compile_and_run_tool drives lint/compile/run (default: verilator)
